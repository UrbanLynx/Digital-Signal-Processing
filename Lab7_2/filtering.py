...
def plot_signal(sig_org, sig_cor, h):
    ...
    axes[0].plot(sig_org.x_dft, sig_org.y_dft, 'g', label='Original Signal')
    axes[0].plot(sig_cor.x_dft, sig_cor.y_dft, 'r', label='Corrupted Signal')
    axes[0].plot(sig_cor.x_dft, sig_cor.y_dft_filter, 'b', label='Filter Signal')
    axes[1].plot(sig_cor.x_dft, h, 'b',lw=2, label='H')
